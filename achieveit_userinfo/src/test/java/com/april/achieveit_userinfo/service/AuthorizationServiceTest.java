...
class AuthorizationServiceTest
{
    ...
    public void setup()
    {
        ProjectUserRelation projectUserRelation1=new ProjectUserRelation("2020-4577-D-01",
                                                                         "SYKJ-20200201-0000",
                                                                         "SYKJ-20200101-0000",
                                                                         290089467161608193L);
        ProjectUserRelation projectUserRelation2=new ProjectUserRelation("2020-4577-D-02",
                                                                         "SYKJ-20200201-0001",
                                                                         "SYKJ-20200101-0010",
                                                                         290089467161608123L);
        ProjectUserRelation projectUserRelation3=new ProjectUserRelation("2020-4577-D-02",
                                                                         "SYKJ-20200201-0003",
                                                                         "SYKJ-20200101-0010",
                                                                         290089467161608125L);
        ...
        ProjectRole projectRole1=new ProjectRole(290089467161608123L,
                                                 "QaLeader");
        ProjectRole projectRole2=new ProjectRole(290089467161608125L,
                                                 "EPG");
        ProjectRole projectRole3=new ProjectRole(290089467161608193L,
                                                 "DevelopmentLeader");
        ...
        ProjectUserPermissionRelation projectUserPermissionRelation=new ProjectUserPermissionRelation("2020-4577-D-02",
                                                                                                      "SYKJ-20200201-0001",
                                                                                                      290089467161608123L,
                                                                                                      5);
        ProjectUserPermissionRelation projectUserPermissionRelation2=new ProjectUserPermissionRelation("2020-4577-D-01",
                                                                                                       "SYKJ-20200201-0000",
                                                                                                       294208653534167040L,
                                                                                                       1);
        ...
        Permission permission1=new Permission(290089467161608123L,
                                              "issue_tracker_access");
        Permission permission2=new Permission(294208701688971264L,
                                              "issue_tracker_modification");
        Permission permission3=new Permission(294208708563435520L,
                                              "working_hour_modification");
        Permission permission4=new Permission(294208716280954880L,
                                              "working_hour_access");
        Permission permission5=new Permission(294208717023346688L,
                                              "working_hour_verification");
        Permission permission6=new Permission(294208731082653696L,
                                              "project_git_modification");
        Permission permission7=new Permission(294208732491939840L,
                                              "project_git_access");
        Permission permission8=new Permission(294208733922197504L,
                                              "mail_list_modification");
        Permission permission9=new Permission(294208740175904768L,
                                              "mail_list_access");
        Permission permission10=new Permission(294208748191219712L,
                                               "file_system_modification");
        Permission permission11=new Permission(294208755745161216L,
                                               "file_system_access");
        ...
        GlobalRole globalRole=new GlobalRole(290104426675306497L,
    ...
    {
        MatcherAssert.assertThat(authorizationService.GetUserProjectRole("2020-4577-D-01",
                                                                         "SYKJ-20200201-0000")
                                         .get("project_id"),
                                 is("2020-4577-D-01"));
    ...
    void batchGetUserRoleFromMultipleProject()
    {
        ...
        MatcherAssert.assertThat(resultList.get(0)
                                         .get("project_id"),
                                 is("2020-4577-D-01"));
        MatcherAssert.assertThat(resultList.get(1)
                                         .get("project_id"),
                                 is("2020-4577-D-02"));
    }
    ...
    void getUserGlobalRole()
    {
        ...
        MatcherAssert.assertThat(map.get("global_role_name"),
    ...
    void getInferior()
    {
        List<String> list=authorizationService.GetInferior("2020-4577-D-02",
                                                           "SYKJ-20200101-0010");
        MatcherAssert.assertThat(list.get(0),
                                 is("SYKJ-20200201-0001"));
        MatcherAssert.assertThat(list.get(1),
                                 is("SYKJ-20200201-0003"));
    ...
    {
        List<String> list=authorizationService.GetUserPermissionName("2020-4577-D-02",
                                                                     "SYKJ-20200201-0001");
        System.out.println(list);
        MatcherAssert.assertThat(list.get(0),
                                 is("issue_tracker_access"));
    }
    ...
    void updateUserProjectRole()
    {
        ...
        map.put("superior_id",
                "SYKJ-20200201-0011");
        map.put("project_role_id",
                "290089467161608193");

        List<Map<String,String>> list=new ArrayList<>();
        list.add(map);
        authorizationService.UpdateUserProjectRole("2020-4577-D-02",
                                                   "SYKJ-20200201-00001",
                                                   list);
        //   MatcherAssert.assertThat(authorizationService.GetUserProjectRole("2020-4577-D-02","SYKJ-20200201-00001").get("superioor_id"),is("SYKJ-20200201-0011"));
    }
    ...
    void updateProjectMember()
    {
        ...
        map.put("project_role_id", "126");
        map.put("superior_id","SYKJ-20200201-0010");
//        map.put("project_role_id_list",
//                "[{\"project_role_id\":\"126\",\"superior_id\":\"SYKJ-20200201-0010\",\"project_role_name\":\"QaLeader\"}]");
        List<Map<String,String>> members=new ArrayList<>();
        members.add(map);
        authorizationService.UpdateProjectMember("2020-4577-D-02",
                                                 members);
        //  MatcherAssert.assertThat(authorizationService.GetProjectMember("2020-4577-D-02").get(0).get("project_role_name"),is("QaLeader"));
    }
    ...
    void updateUserProjectPermission()
    {
        ...
        authorizationService.UpdateUserProjectPermission("2020-4577-D-02",
                                                         "SYKJ-20200201-0001",
                                                         list);
        String s=authorizationService.GetUserPermissionName("2020-4577-D-02",
                                                            "SYKJ-20200201-0001")
                .get(0);
        MatcherAssert.assertThat(s,
                                 is("working_hour_access"));
    ...
    {
        System.out.println(authorizationService.getAllProjectRoles());
    }

    @AfterAll
    public void teardown()
    {
        projectUserRelationMapper.deleteByProjectIdAndUserId("2020-4577-D-01",
                                                             "SYKJ-20200201-0000");
        projectUserRelationMapper.deleteByProjectIdAndUserId("2020-4577-D-02",
                                                             "SYKJ-20200201-0001");
        projectUserRelationMapper.deleteByProjectIdAndUserId("2020-4577-D-02",
                                                             "SYKJ-20200201-0003");
        ...
        projectUserPermissionRelationMapper.deleteByProjectIdAndUserIdAndPermissionId("2020-4577-D-02",
                                                                                      "SYKJ-20200201-0001",
                                                                                      290089467161608123L);
        projectUserPermissionRelationMapper.deleteByProjectIdAndUserIdAndPermissionId("2020-4577-D-01",
                                                                                      "SYKJ-20200201-0000",
                                                                                      294208653534167040L);
